...
void loop(){
  ...
  // 2) Bulb pressure → send as force
  float raw = bulbScale.get_units(5);
  float kPa = raw * 1.0; // adjust calibration
  ...
  // 3) H-bridge drives actuator to match armForce
